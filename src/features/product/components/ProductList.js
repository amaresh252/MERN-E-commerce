...
import { fetchAllProductsAsync,selectAllProducts ,fetchAllProductsByFilterAsync, selectTotalItems,fetchBrandsAsync,
  fetchCategoriesAsync,selectBrands,selectCategories} from '../ProductSlice';
...
export default function ProductList() {
  ...
  useEffect(() => { 
  dispatch(fetchAllProductsByFilterAsync({ pagination, filter ,sort }));
...
dispatch(fetchBrandsAsync())
  ...
  return (
    ...
    <div className="bg-white">
      ...
      <div> 
      <MobileFilter  mobileFiltersOpen={mobileFiltersOpen} setMobileFiltersOpen={setMobileFiltersOpen} handleChange={handleChange} filters={filters}></MobileFilter>
...
function DesktopFilter({handleChange,filters}){
  return (
    <>
     {/* Filters */}
